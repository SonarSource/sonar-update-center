...
public class GeneratePluginsDataJsonMojo extends AbstractMojo {
  ...
  GeneratePluginsDataJsonMojo setOutputDir(File d) {
    this.outputDir = d;
    return this;
  }

  GeneratePluginsDataJsonMojo setInputFile(File f) {
    this.inputFile = f;
    return this;
  }
}
